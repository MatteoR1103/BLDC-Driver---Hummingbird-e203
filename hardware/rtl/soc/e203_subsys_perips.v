...
//=====================================================================
//
// Designer   : Bob Hu, Prandi Mattia, Rubini Matteo
//
// Description:
//  The peirpheral bus and the connected devices, gpio modified by Prandi and Rubini
// V4.0 added A,B,C pins
// ====================================================================
...
module e203_subsys_perips(
  ...
  // BLDC DRIVER CONTROLLER GPIO ASSIGNMENTS
  
  // HAL C
  assign BLDC_driver_pad_in_HAL_C = io_pads_gpio_20_i_ival;
  assign io_pads_gpio_20_o_oval  = 1'b0;
  assign io_pads_gpio_20_o_oe    = 1'b0;
  assign io_pads_gpio_20_o_ie    = 1'b1;
  assign io_pads_gpio_20_o_pue   = 1'b0;
  assign io_pads_gpio_20_o_ds    = 1'b0;

  // HAL B
  assign BLDC_driver_pad_in_HAL_B = io_pads_gpio_21_i_ival;
  assign io_pads_gpio_21_o_oval  = 1'b0;
  assign io_pads_gpio_21_o_oe    = 1'b0;
  assign io_pads_gpio_21_o_ie    = 1'b1;
  assign io_pads_gpio_21_o_pue   = 1'b0;
  assign io_pads_gpio_21_o_ds    = 1'b0;

  // HAL A
  assign BLDC_driver_pad_in_HAL_A = io_pads_gpio_22_i_ival;
  assign io_pads_gpio_22_o_oval  = 1'b0;
  assign io_pads_gpio_22_o_oe    = 1'b0;
  assign io_pads_gpio_22_o_ie    = 1'b1;
  assign io_pads_gpio_22_o_pue   = 1'b0;
  assign io_pads_gpio_22_o_ds    = 1'b0;

  // BREAK
  assign BLDC_driver_pad_in_BREAK = io_pads_gpio_23_i_ival;
  assign io_pads_gpio_23_o_oval  = 1'b0;
  assign io_pads_gpio_23_o_oe    = 1'b0;
  assign io_pads_gpio_23_o_ie    = 1'b1;
  assign io_pads_gpio_23_o_pue   = 1'b0;
  assign io_pads_gpio_23_o_ds    = 1'b0;

  // HS_U
  // assign io_pads_gpio_26_i_ival  = 1'b0;
  assign io_pads_gpio_26_o_oval  = BLDC_driver_pad_out_0;
  assign io_pads_gpio_26_o_oe    = 1'b1;
  assign io_pads_gpio_26_o_ie    = 1'b0;
  assign io_pads_gpio_26_o_pue   = 1'b0;
  assign io_pads_gpio_26_o_ds    = 1'b0;

  // LS_U
  // assign io_pads_gpio_27_i_ival  = 1'b0;
  assign io_pads_gpio_27_o_oval  = BLDC_driver_pad_out_1;
  assign io_pads_gpio_27_o_oe    = 1'b1;
  assign io_pads_gpio_27_o_ie    = 1'b0;
  assign io_pads_gpio_27_o_pue   = 1'b0;
  assign io_pads_gpio_27_o_ds    = 1'b0;

  // HS_V
  // assign io_pads_gpio_28_i_ival  = 1'b0;
  assign io_pads_gpio_28_o_oval  = BLDC_driver_pad_out_2;
  assign io_pads_gpio_28_o_oe    = 1'b1;
  assign io_pads_gpio_28_o_ie    = 1'b0;
  assign io_pads_gpio_28_o_pue   = 1'b0;
  assign io_pads_gpio_28_o_ds    = 1'b0;

  // LS_V
  // assign io_pads_gpio_29_i_ival  = 1'b0;
  assign io_pads_gpio_29_o_oval  = BLDC_driver_pad_out_3;
  assign io_pads_gpio_29_o_oe    = 1'b1;
  assign io_pads_gpio_29_o_ie    = 1'b0;
  assign io_pads_gpio_29_o_pue   = 1'b0;
  assign io_pads_gpio_29_o_ds    = 1'b0;

  // HS_W
  // assign io_pads_gpio_30_i_ival  = 1'b0;
  assign io_pads_gpio_30_o_oval  = BLDC_driver_pad_out_4;
  assign io_pads_gpio_30_o_oe    = 1'b1;
  assign io_pads_gpio_30_o_ie    = 1'b0;
  assign io_pads_gpio_30_o_pue   = 1'b0;
  assign io_pads_gpio_30_o_ds    = 1'b0;

  // LS_W
  // assign io_pads_gpio_31_i_ival  = 1'b0;
  assign io_pads_gpio_31_o_oval  = BLDC_driver_pad_out_5;
  assign io_pads_gpio_31_o_oe    = 1'b1;
  assign io_pads_gpio_31_o_ie    = 1'b0;
  assign io_pads_gpio_31_o_pue   = 1'b0;
  assign io_pads_gpio_31_o_ds    = 1'b0;
  ...
  assign gpio_iof_1_25_o_oe        = 1'b1;
  ...
  assign gpio_iof_1_31_o_ival      = 1'b0;
  ...
  wire                     BLDC_driver_icb_cmd_valid;
  wire                     BLDC_driver_icb_cmd_ready;
  wire [32-1:0]            BLDC_driver_icb_cmd_addr; 
  wire                     BLDC_driver_icb_cmd_read; 
  wire [32-1:0]            BLDC_driver_icb_cmd_wdata;
  
  wire                     BLDC_driver_icb_rsp_valid;
  wire                     BLDC_driver_icb_rsp_ready;
  wire [32-1:0]            BLDC_driver_icb_rsp_rdata;

  wire                     BLDC_driver_pad_out_0;
  wire                     BLDC_driver_pad_out_1;
  wire                     BLDC_driver_pad_out_2;
  wire                     BLDC_driver_pad_out_3;
  wire                     BLDC_driver_pad_out_4;
  wire                     BLDC_driver_pad_out_5;
  wire                     BLDC_driver_pad_in_BREAK;
  wire                     BLDC_driver_pad_in_HAL_A;
  wire                     BLDC_driver_pad_in_HAL_B;
  wire                     BLDC_driver_pad_in_HAL_C;
  ...
  //  * BLDC0     
    ...
    .o5_icb_cmd_valid  (BLDC_driver_icb_cmd_valid),
    .o5_icb_cmd_ready  (BLDC_driver_icb_cmd_ready),
    .o5_icb_cmd_addr   (BLDC_driver_icb_cmd_addr ),
    .o5_icb_cmd_read   (BLDC_driver_icb_cmd_read ),
    .o5_icb_cmd_wdata  (BLDC_driver_icb_cmd_wdata),
    .o5_icb_cmd_wmask  (),
    .o5_icb_cmd_lock   (),
    .o5_icb_cmd_excl   (),
    .o5_icb_cmd_size   (),
    ...
    .o5_icb_rsp_valid  (BLDC_driver_icb_rsp_valid),
    .o5_icb_rsp_ready  (BLDC_driver_icb_rsp_ready),
    .o5_icb_rsp_err    (1'b0  ),
    .o5_icb_rsp_excl_ok(1'b0  ),
    .o5_icb_rsp_rdata  (BLDC_driver_icb_rsp_rdata),
...
// I CONNECT THOSE PINS DIRECTRLY TO THE CONTROLLER
/*    
...
// BLDC driver module
BLDC_driver u_BLDC_driver_top(
    .clk            (clk),
    .rst_n          (rst_n),
    .i_icb_cmd_valid (BLDC_driver_icb_cmd_valid),
    .i_icb_cmd_ready (BLDC_driver_icb_cmd_ready),
    .i_icb_cmd_addr  (BLDC_driver_icb_cmd_addr ),
    .i_icb_cmd_read  (BLDC_driver_icb_cmd_read ),
    .i_icb_cmd_wdata (BLDC_driver_icb_cmd_wdata),

    .i_icb_rsp_valid (BLDC_driver_icb_rsp_valid),
    .i_icb_rsp_ready (BLDC_driver_icb_rsp_ready),
    .i_icb_rsp_rdata (BLDC_driver_icb_rsp_rdata), 

    .io_pad_out_0       (BLDC_driver_pad_out_0),
    .io_pad_out_1       (BLDC_driver_pad_out_1),
    .io_pad_out_2       (BLDC_driver_pad_out_2),
    .io_pad_out_3       (BLDC_driver_pad_out_3),
    .io_pad_out_4       (BLDC_driver_pad_out_4),
    .io_pad_out_5       (BLDC_driver_pad_out_5),
    .io_pad_in_BREAK    (BLDC_driver_pad_in_BREAK),
    .io_pad_in_HAL_A    (BLDC_driver_pad_in_HAL_A),
    .io_pad_in_HAL_B    (BLDC_driver_pad_in_HAL_B),
    .io_pad_in_HAL_C    (BLDC_driver_pad_in_HAL_C)
);
